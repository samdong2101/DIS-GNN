...
band_gaps = [structure['band_gap'] for structure in structures]
band_gaps_20 = [band_gaps[i] for i in structures_20_ind]
structures_20 = [Structure.from_dict(structures[i]['structure']) for i in structures_20_ind]
