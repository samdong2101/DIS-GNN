...
class Convolution(MessagePassing):
    ...
    def forward(self, node_inp, edge_index, edge_feature, global_state = None, cells = None, coords = None):
        concat_edge, concat_node = self.message(edge_index[0],edge_index[1], node_inp, node_inp, edge_feature, global_state, cells, coords)
        return concat_node
    ...
    def message(self, edge_index_i, edge_index_j, node_inp_i, node_inp_j, edge_feature, global_state, cells, coords):
        '''
...
class GeneralConv(nn.Module):
    ...
    def forward(self, meta_xs, edge_index, edge_feature, global_state, cells, coords):
        return self.base_conv(meta_xs, edge_index, edge_feature, global_state, cells, coords)
