...
class DataLoader:
  ...
  def get_data(self):
    ...
    batched_node_features, batched_edge_indices, batched_edge_features, batched_labels, batched_node_indices = self.batch_data(self.batch_size, node_features, edge_indices, edge_features, labels)
    return batched_node_features, batched_edge_indices, batched_edge_features, batched_labels, batched_node_indices
